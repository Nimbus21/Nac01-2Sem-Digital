...
INSERT INTO TB_PACIENTE (cd_paciente, nm_contato, ds_endereco, ds_genero, dt_nascimento, nm_paciente, nm_mae, ds_orgao, nr_rg, tl_telefone, dt_transplante) VALUES
 ...
 (SQ_MONITORAMENTO.nextval, false, 'primeiro monitoramento Thandy', '2021-08-04', 1000, '1021-08-09', 1, 1, 1);
 
  INSERT INTO TB_MONITORAMENTO (cd_monitoramento, st_monitoramento, ds_monitoramento, dt_fim, nr_frequencia_segundos, dt_inicio, cd_hospital, cd_medico, cd_paciente) VALUES
 (SQ_MONITORAMENTO.nextval, false, 'segundo monitoramento Thandy', '2021-10-04', 2000, '1022-08-09', 1, 1, 1);
 
  INSERT INTO TB_MONITORAMENTO (cd_monitoramento, st_monitoramento, ds_monitoramento, dt_fim, nr_frequencia_segundos, dt_inicio, cd_hospital, cd_medico, cd_paciente) VALUES
 (SQ_MONITORAMENTO.nextval, false, 'primeiro monitoramento Gui', '2021-08-04', 3000, '1021-08-09', 1, 1, 2);
 
  INSERT INTO TB_MONITORAMENTO (cd_monitoramento, st_monitoramento, ds_monitoramento, dt_fim, nr_frequencia_segundos, dt_inicio, cd_hospital, cd_medico, cd_paciente) VALUES
 (SQ_MONITORAMENTO.nextval, false, 'segundo monitoramento Gui', '2021-08-04', 4000, '1021-08-09', 1, 1, 2);
